...
public class Ponto {
    ...
    void status(){
        System.out.println("Ponto: " + this.nome);
    ...
    void designar(){
        if (this.ocupado == true){
            System.out.println("O/A ponto já está designado para outra peça.");
        } else{
            System.out.println("Para que peça quer designar o(a) ponto?");
            
            //Listar peças e abrir input
            System.out.println("Ponto " + this.nome + " foi designado para a peça " /*+ peça*/);
        }   
    }
    
    void desocupar(){
        if (this.ocupado == false){
            System.out.println("O/A ponto já se encontra desocupado(a).");
        }else{
            System.out.println("Ponto desocupado.");
            this.ocupado = false;
        }
    }

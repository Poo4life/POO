...
public class Figurante {
   String nome;
    ...
    void status(){
        System.out.println("Figurante: " + this.nome);
    ...
    void designar(){
        if (this.ocupado == true){
            System.out.println("O figurante já está designado para outra peça.");
        } else{
            System.out.println("Para que peça quer designar o(a) figurante?");
            
            //Listar peças e abrir input
            System.out.println("figurante " + this.nome + " foi designado para a peça " /*+ peça*/);
        }   
    }
    
    void desocupar(){
        if (this.ocupado == false){
            System.out.println("O figurante já se encontra desocupado.");
        }else{
            System.out.println("Figurante desocupado.");
            this.ocupado = false;
        }
    }    
}

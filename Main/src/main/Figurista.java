...
void status(){
        System.out.println("Figurista: " + this.nome);
    ...
    void designar(){
        if (this.ocupado == true){
            System.out.println("O figurista já está designado para outra peça.");
        } else{
            System.out.println("Para que peça quer designar o(a) figurista?");
            
            //Listar peças e abrir input
            System.out.println("Figurista " + this.nome + " foi designado para a peça " /*+ peça*/);
        }   
    }
    
    void desocupar(){
        if (this.ocupado == false){
            System.out.println("O figurista já se encontra desocupado.");
        }else{
            System.out.println("Figurista desocupado.");
            this.ocupado = false;
        }
    }    

...
public class Iluminador {
    ...
    void status(){
        System.out.println("Iluminador(a): " + this.nome);
    ...
    void designar(){
        if (this.ocupado == true){
            System.out.println("O/A iluminador(a) já está designado(a) para outra peça.");
        } else{
            System.out.println("Para que peça quer designar o(a) iluminador(a)?");
            
            //Listar peças e abrir input
            System.out.println("Iluminador(a) " + this.nome + " foi designado para a peça " /*+ peça*/);
        }   
    }
    
    void desocupar(){
        if (this.ocupado == false){
            System.out.println("O/A iluminador(a) já se encontra desocupado(a).");
        }else{
            System.out.println("Iluminador(a) desocupado(a).");
            this.ocupado = false;
        }
    }

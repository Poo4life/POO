...
public class Dramaturgo {
    ...
    void status(){
        System.out.println("Dramaturgo: " + this.nome);
    ...
    void designar(){
        if (this.ocupado == true){
            System.out.println("O Dramaturgo já está designado para outra peça.");
        } else{
            System.out.println("Para que peça quer designar o(a) Dramaturgo?");
            
            //Listar peças e abrir input
            System.out.println("Dramaturgo " + this.nome + " foi designado para a peça " /*+ peça*/);
        }   
    }
    
    void desocupar(){
        if (this.ocupado == false){
            System.out.println("O Dramaturgo já se encontra desocupado.");
        }else{
            System.out.println("Dramaturgo desocupado.");
            this.ocupado = false;
        }
    }
